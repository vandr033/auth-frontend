    ...
    extend: {
      ...
      colors: {
        admin: {
          ...
          "brand-hover": "var(--admin-brand-hover)",
          "brand-soft": "var(--admin-brand-soft)",
          "brand-soft-text": "var(--admin-brand-soft-text)",
      ...
      boxShadow: {
        ...
        admin: "var(--admin-shadow-card)",
        "admin-lift": "var(--admin-shadow-lift)",
