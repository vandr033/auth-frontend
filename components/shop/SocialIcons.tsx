...
const platformConfig = [
    ...
    { key: "x_twitter" as const, Icon: Twitter, label: "X / Twitter" },
    { key: "youtube" as const, Icon: Youtube, label: "YouTube" },
    { key: "whatsapp" as const, Icon: WhatsAppIcon, label: "WhatsApp" },
];

export function SocialIcons({ socialLinks, className, iconSize = 20 }: SocialIconsProps) {
    const activeLinks = platformConfig.filter(
