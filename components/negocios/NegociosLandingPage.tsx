...
const SECTORS = [
  {
    ...
    className: "xl:col-span-3 xl:rotate-[-2deg]",
  },
  {
    title: "Bienestar",
    note: "Experiencia premium y recompra.",
    image: "/assets/priconpri/negocios cards/wellness.webp",
    className: "xl:col-span-4 xl:translate-y-10",
  },
  {
    title: "Movimiento",
    note: "Sesiones, cupos y recurrencia.",
    image: "/assets/priconpri/negocios cards/movement.webp",
    className: "xl:col-span-3 xl:-translate-y-6",
  },
  {
    title: "Estudios",
    note: "Staff, horarios y turnos vivos.",
    image: "/assets/priconpri/negocios cards/fitness.webp",
    className: "xl:col-span-2 xl:rotate-[3deg]",
  },
  {
    title: "Academias",
  ...
  },
  {
    ...
    className: "xl:col-span-2 xl:-translate-y-8",
  },
  {
    title: "Belleza",
    note: "Marca, reservas y clientes fieles.",
    image: "/assets/priconpri/negocios cards/beauty.webp",
    className: "xl:col-span-3 xl:rotate-[2deg]",
  },
  {
  ...
  {
    title: "Rendimiento",
    note: "Programas, comunidad y métricas.",
    image: "/assets/priconpri/negocios cards/recovery.webp",
    className: "xl:col-span-3 xl:translate-y-6",
  },
];
...
function CoreProductFeature({
  ...
  const cardClasses = [
    ...
    "bg-white text-black md:translate-y-6",
    "bg-[linear-gradient(135deg,rgba(6,180,227,0.12),rgba(255,255,255,0.98))] text-black md:-translate-y-6",
  ...
  return (
    <article
      className={cn(
        "group relative overflow-hidden border border-black p-6 transition-transform duration-300 hover:-translate-y-1 sm:p-7",
        cardClasses[index],
    ...
    >
      ...
      <div className="relative mt-8 max-w-[34rem]">
        <h3 className="font-business-display text-[clamp(2.6rem,4.6vw,4.2rem)] uppercase leading-[0.88] tracking-[-0.03em]">
          {product.title}
        </h3>
        <p
          className={cn(
            "mt-4 max-w-[34ch] text-sm leading-7",
...
function AddOnFeature({
  ...
  const Icon = PRODUCT_ICONS[product.key] ?? Sparkles;
  const offsets = ["xl:translate-y-2", "xl:translate-y-10", "xl:-translate-y-4", "xl:translate-y-6"];
  ...
  return (
    ...
    >
      ...
      <h3 className="mt-6 font-business-display text-[clamp(2rem,3vw,2.8rem)] uppercase leading-[0.9] tracking-[-0.03em]">
        {product.shortTitle}
      </h3>
      <p className="mt-3 text-sm leading-7 text-slate-700">{product.tagline}</p>
...
function SectorCard({
  ...
  return (
    <article
      className={cn(
        "group relative min-h-[250px] overflow-hidden border border-black bg-black text-white",
        sector.className,
      )}
    >
      <Image
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,5,5,0.02),rgba(5,5,5,0.72))]" />
      ...
      <div className="absolute inset-x-0 bottom-0 p-5">
        <h3 className="font-business-display text-[clamp(2.2rem,4vw,3.4rem)] uppercase leading-[0.9] tracking-[-0.03em]">
          {sector.title}
        </h3>
...
export function NegociosLandingPage() {
  ...
  return (
    <main className="bg-biz-surface text-biz-heading-dark">
      <section
        id="inicio"
        className="relative isolate overflow-hidden border-b border-black/[0.08] bg-[radial-gradient(circle_at_top_left,rgba(231,56,134,0.12),transparent_28%),radial-gradient(circle_at_82%_18%,rgba(250,255,54,0.32),transparent_18%),linear-gradient(180deg,#f3f3f3_0%,#f6f2ed_100%)]"
      >
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-[6%] top-16 h-36 w-56 rotate-[-14deg] border border-black/[0.08] bg-white/[0.55]" />
          <div className="absolute right-[8%] top-24 h-24 w-40 rotate-[11deg] bg-biz-sky-surge/[0.16] blur-3xl" />
          <div className="absolute bottom-10 left-1/2 h-40 w-40 -translate-x-1/2 rounded-full bg-biz-barbie-pink/[0.16] blur-3xl" />
        </div>

        <div className="mx-auto grid max-w-7xl gap-14 px-6 py-14 lg:grid-cols-[0.96fr_1.04fr] lg:px-10 lg:py-20">
          <div className="relative z-10 max-w-[680px]">
            ...
            <SectionEyebrow className="mt-8 text-biz-barbie-pink">
              Editorial pop premium
            </SectionEyebrow>
            <h1 className="mt-4 font-business-display text-[clamp(4rem,10vw,8.4rem)] uppercase leading-[0.82] tracking-[-0.04em]">
              ARMÁ TU SISTEMA.
            </h1>
            <p className="mt-6 max-w-[34rem] text-[1rem] leading-8 text-slate-700 sm:text-[1.08rem]">
          ...
          <div className="relative mx-auto w-full max-w-[640px]">
            <div className="relative min-h-[520px]">
              <div className="absolute left-0 top-10 h-[320px] w-[64%] rotate-[-5deg] border border-black bg-white p-5 shadow-[0_28px_60px_rgba(15,23,42,0.14)] sm:p-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="font-bebas text-[14px] uppercase tracking-[0.16em] text-biz-barbie-pink">
                      Selección actual
                    </p>
                    <p className="mt-2 font-business-display text-[clamp(2.2rem,4vw,3.4rem)] uppercase leading-[0.9]">
                      Tu sistema.
                    </p>
                  </div>
                ...
                <div className="mt-6 border border-black/[0.08] bg-black/[0.03] p-4">
                  <p className="text-[11px] font-black uppercase tracking-[0.08em] text-slate-500">
                    Lógica de selección
                  </p>
              ...
              <div className="absolute bottom-0 right-0 z-10 w-[72%] rotate-[4deg] border border-black bg-black p-5 text-white shadow-[0_36px_70px_rgba(5,5,5,0.28)] sm:p-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p className="font-bebas text-[14px] uppercase tracking-[0.16em] text-biz-yellow">
                      Resumen premium
                    </p>
                    <p className="mt-2 font-business-display text-[clamp(2.4rem,5vw,4.1rem)] uppercase leading-[0.88]">
                      Hoy pagás 0 Bs.
                    </p>
                  </div>
                ...
                <p className="mt-5 max-w-[26ch] text-sm leading-7 text-white/[0.76]">
                  Bundle y anual se calculan automáticamente cuando llegás al configurador real.
                </p>
              </div>

              <div className="absolute right-12 top-0 z-20 rotate-[8deg] bg-biz-yellow px-4 py-2 text-[11px] font-black uppercase tracking-[0.08em] text-black shadow-[0_18px_34px_rgba(0,0,0,0.14)]">
                Primer mes gratis
              </div>

              <div className="absolute bottom-24 left-[28%] z-0 hidden h-[220px] w-[220px] border border-black/[0.08] bg-white/[0.58] p-3 lg:block">
                <Image
      ...
      <section id="productos" className="border-b border-black/[0.08] bg-white px-6 py-16 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 xl:grid-cols-[0.72fr_1.28fr]">
            <div className="max-w-[30rem]">
              ...
              <h2 className="mt-3 font-business-display text-[clamp(3rem,7vw,5.8rem)] uppercase leading-[0.84] tracking-[-0.04em]">
              ...
              <div className="mt-8 border border-black bg-biz-yellow p-5 text-black">
      ...
      <section
        id="addons"
        className="border-b border-black/[0.08] bg-[linear-gradient(180deg,#f6f2ed_0%,#eef7fb_100%)] px-6 py-16 lg:px-10 lg:py-20"
      >
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 xl:grid-cols-[0.64fr_1.36fr]">
            <div className="max-w-[28rem]">
              <SectionEyebrow className="text-biz-sky-surge">
                DESPUÉS SUMÁ HERRAMIENTAS PARA CRECER.
              </SectionEyebrow>
              <h2 className="mt-3 font-business-display text-[clamp(2.8rem,6vw,5rem)] uppercase leading-[0.86] tracking-[-0.04em]">
      ...
      <section
        id="pricing"
        className="border-b border-black/[0.08] bg-[linear-gradient(180deg,#ece8e3_0%,#f7f4ef_100%)] px-6 py-16 lg:px-10 lg:py-20"
      >
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 xl:grid-cols-[0.72fr_1.28fr] xl:items-end">
            <div>
              ...
              <h2 className="mt-3 font-business-display text-[clamp(3rem,7vw,6rem)] uppercase leading-[0.84] tracking-[-0.04em]">
                Un configurador que se siente a la altura.
              </h2>
            </div>
            <p className="max-w-[46ch] text-[1rem] leading-8 text-slate-700">
      ...
      <section id="bundle" className="border-b border-black bg-biz-yellow px-6 py-16 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 xl:grid-cols-[0.88fr_1.12fr]">
            <div className="max-w-[34rem]">
              ...
              <h2 className="mt-3 font-business-display text-[clamp(3.4rem,8vw,6.8rem)] uppercase leading-[0.8] tracking-[-0.04em] text-black">
                El descuento también es parte del diseño del plan.
              </h2>
              <p className="mt-5 max-w-[30rem] text-[1rem] leading-8 text-black/80">
              ...
              {BILLBOARD_TIERS.map((tier, index) => (
                <article
                  ...
                  className={cn(
                    ...
                    index === 4 && "sm:col-span-2 xl:col-span-1 xl:translate-y-10",
                  )}
                >
                  <p
                    className={cn(
                  ...
                  <p className="mt-4 font-business-display text-[clamp(2.3rem,4vw,3.6rem)] uppercase leading-[0.88] tracking-[-0.03em]">
                    {tier.value}
                  </p>
                </article>
              ))}
      ...
      <section id="sectores" className="border-b border-black/[0.08] bg-white px-6 py-16 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-4 xl:grid-cols-12">
            <article className="border border-black bg-black p-6 text-white xl:col-span-4 xl:row-span-2">
              <SectionEyebrow className="text-biz-yellow">
                HECHO PARA NEGOCIOS QUE VIVEN DE SU AGENDA, SUS CUPOS O SU COMUNIDAD.
              </SectionEyebrow>
              <h2 className="mt-4 font-business-display text-[clamp(2.8rem,5vw,4.6rem)] uppercase leading-[0.86] tracking-[-0.04em]">
                Sectores que necesitan ritmo, orden y marca.
              </h2>
              <p className="mt-5 max-w-[28ch] text-sm leading-7 text-white/[0.78]">
      ...
      <section id="como-funciona" className="border-b border-black/[0.08] bg-[#f5f3ef] px-6 py-16 lg:px-10 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <SectionEyebrow className="text-slate-500">EMPEZAR ES SIMPLE.</SectionEyebrow>
          <h2 className="mt-3 max-w-[18ch] font-business-display text-[clamp(3rem,6vw,5.5rem)] uppercase leading-[0.84] tracking-[-0.04em]">
            Tres pasos y entrás.
          </h2>

          <div className="mt-10 grid gap-4 lg:grid-cols-3">
            {HOW_IT_WORKS.map((item) => (
              <article key={item.step} className="border border-black/[0.08] bg-white p-6">
                <p className="text-[11px] font-black uppercase tracking-[0.08em] text-biz-barbie-pink">
                  Paso {item.step}
                </p>
                <h3 className="mt-4 font-business-display text-[clamp(2rem,4vw,3rem)] uppercase leading-[0.9] tracking-[-0.03em]">
                  {item.title}
                </h3>
          ...
          <div className="mt-8 border border-black bg-black px-6 py-8 text-white lg:px-8">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.08em] text-biz-yellow">
                  CTA directo
                </p>
                <h3 className="mt-3 font-business-display text-[clamp(2.4rem,5vw,4.2rem)] uppercase leading-[0.86] tracking-[-0.04em]">
      ...
      <section id="faq" className="border-b border-black/[0.08] bg-white px-6 py-16 lg:px-10 lg:py-18">
        <div className="mx-auto max-w-7xl">
      ...
      <section className="relative isolate overflow-hidden bg-biz-barbie-pink px-6 py-16 text-black lg:px-10 lg:py-20">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-[-4%] top-8 h-32 w-56 rotate-[-12deg] border border-black/[0.08] bg-white/[0.2]" />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_320px] lg:items-end">
          <div>
            ...
            <h2 className="mt-3 max-w-[11ch] font-business-display text-[clamp(3.6rem,9vw,7.4rem)] uppercase leading-[0.8] tracking-[-0.05em]">
              Cerrá la idea. Abrí tu cuenta.
            </h2>
            <p className="mt-5 max-w-[34rem] text-[1rem] leading-8 text-black/[0.78]">
          ...
          <div className="relative mx-auto h-[260px] w-full max-w-[280px] border border-black bg-white/[0.24] p-4">
            <Image
              src="/assets/priconpri/mascot.webp"
              alt="Mascota Priconpri"
              fill
