    ...
    <div className="space-y-2">
      ...
      {sourceMode ? (
        ...
        <div
          ...
          className={`w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-admin-brand ${minHeightClassName}`}
