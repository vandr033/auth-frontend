    ...
    return (
        <div className="flex h-[100dvh] overflow-hidden bg-admin-page">
            ...
            <div className="flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden lg:ml-64">
                {/* Top Header */}
                <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center gap-4 border-b border-admin-border bg-admin-surface px-4 shadow-sm lg:px-6">
                    <button
                ...
                {/* Page Content */}
                <main className="admin-scrollbar flex-1 overflow-y-auto bg-admin-page p-4 lg:p-6">{children}</main>
            </div>
        </div>
    );
}
